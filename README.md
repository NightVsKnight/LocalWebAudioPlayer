...
* add a github issue that the Previous control should not go to a random song but should go back in history.
  this would require that github issue # 5 is implemented.
* add OS aware media controller to be able to next/play/pause from BT and system tray
